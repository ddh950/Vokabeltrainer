...
public class Gui {
	...
	public void bAdd_ActionPerformed(ActionEvent evt) {
		...
		if (!txfieldDeutsch.getText().equals("") && !txfieldEnglisch.getText().equals("")) {
			...
			DatabaseHandler.databaseController.vocablesEnglish.put(DatabaseHandler.counter, txfieldEnglisch.getText());

			germanListModel.addElement(txfieldDeutsch.getText());
			DatabaseHandler.databaseController.vocablesGerman.put(DatabaseHandler.counter, txfieldDeutsch.getText());
