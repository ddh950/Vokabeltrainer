...
public class Gui {
	...
	public void createGui(String title) {
		...
		id = DatabaseHandler.databaseController.getid();
	...
	public void bAdd_ActionPerformed(ActionEvent evt) {
		...
		if (!txfieldDeutsch.getText().equals("") && !txfieldEnglisch.getText().equals("")) {
			...
			DatabaseHandler.databaseController.vocablesEnglish.put(id, txfieldEnglisch.getText());

			germanListModel.addElement(txfieldDeutsch.getText());
			DatabaseHandler.databaseController.vocablesGerman.put(id, txfieldDeutsch.getText());
	...
	public void bRemove_ActionPerformed(ActionEvent evt) {
		DatabaseHandler.databaseController.vocablesGerman.remove(englischList.getSelectedIndex() + 1);
		DatabaseHandler.databaseController.vocablesEnglish.remove(englischList.getSelectedIndex() + 1);
